...
def main():
    ...
    try:
        ...
        logger.error("Please run this script through: python3 scripts/run_dev.py run --script train_autonomous_real_data_host.py --gpu")
        return False
    ...
    # ====================================================================
    # STEP 3: GENERATE REAL PREDICTIONS & EVALUATE FINANCIAL PERFORMANCE
    # ====================================================================
