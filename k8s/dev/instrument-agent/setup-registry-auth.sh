#!/bin/bash
# Script to set up registry authentication for Instrument Agent deployment
...
if [ "$#" -lt 2 ]; then
    ...
    echo "Example: $0 ats-genai ats-dev"
    exit 1
fi
...
echo "You can now update your CronJob and Job to use the 'registry-credentials' secret."
echo "Example:"
echo "---"
echo "spec:"
echo "  template:"
...
echo "      containers:"
echo "      - name: instrument-agent"
echo "        image: gcr.io/$PROJECT_ID/instrument-data-agent:dev"
echo "---"
