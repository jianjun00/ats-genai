...
class DeepAgentFunctionalityTests:
    ...
    async def test_step_1_database_connectivity(self):
        ...
        try:
            ...
            # Assume we have the standard 3 tables: polygon, tiingo, eodhd
            ...
            await self.log_test(1, "Service & Database Connectivity", False, f"Error: {e}")
            return False, []
    ...
    async def test_step_2_data_availability(self):
        ...
        try:
            ...
            # Mock date info since we can't query directly
            ...
            await self.log_test(2, "Data Availability", False, f"Error: {e}")
            return False, {}, None
    ...
    async def test_step_3_check_for_existing_data_issues(self, data_stats):
        ...
        try:
            ...
            try:
                ...
                existing_issues['has_quality_endpoint'] = False

            # If we have substantial data from multiple sources, there should be quality issues to detect
            ...
            await self.log_test(3, "Check Existing Data Issues", False, f"Error: {e}")
            return False, []
    ...
    async def test_step_4_start_agent_fresh(self):
        ...
        try:
            ...
            await self.log_test(4, "Agent Fresh Start", False, f"Error: {e}")
            return False
    ...
    async def test_step_5_wait_for_monitoring_cycles(self):
        ...
        try:
            ...
            await self.log_test(5, "Monitoring Cycles", False, f"Error: {e}")
            return False
    ...
    async def test_step_6_check_issue_detection_via_api(self):
        ...
        try:
            ...
            await self.log_test(6, "Issue Detection API", False, f"Error: {e}")
            return False
    ...
    async def test_step_7_check_dashboard_issue_display(self):
        ...
        try:
            ...
            await self.log_test(7, "Dashboard Issue Display", False, f"Error: {e}")
            return False, {}
    ...
    async def test_step_8_verify_issue_details(self):
        ...
        try:
            ...
            await self.log_test(8, "Issue Details Verification", False, f"Error: {e}")
            return False
    ...
    async def test_step_9_test_issue_resolution_workflow(self):
        ...
        try:
            ...
            await self.log_test(9, "Issue Resolution Workflow", False, f"Error: {e}")
            return False
    ...
    async def test_step_10_verify_agent_monitoring_persistence(self):
        ...
        try:
            ...
            await self.log_test(10, "Agent Monitoring Persistence", False, f"Error: {e}")
            return False
...
async def run_deep_agent_functionality_test():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print(f"💥 Deep test suite failed: {e}")
            await page.screenshot(path="deep_test_suite_failure.png")
            return False
        finally:
            await browser.close()
