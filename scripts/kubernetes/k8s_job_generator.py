...
def create_backfill_job() -> JobConfig:
    ...
    job.add_env_var("PYTHONDONTWRITEBYTECODE", "1")
    ...
    # Add Ray configuration to fix autoscaling issues
    job.add_env_var("RAY_SCHEDULER_EVENTS", "0")
    job.add_env_var("RAY_DISABLE_AUTOMATIC_AUTOSCALING", "1")
