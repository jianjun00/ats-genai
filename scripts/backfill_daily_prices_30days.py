...
Usage:
    PYTHONPATH=src python3 scripts/backfill_daily_prices_30days.py
    PYTHONPATH=src python3 scripts/backfill_daily_prices_30days.py --vendor polygon
    PYTHONPATH=src python3 scripts/backfill_daily_prices_30days.py --debug
"""
