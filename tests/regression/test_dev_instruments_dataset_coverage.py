#!/usr/bin/env python3
"""
Regression test to ensure dev_instruments dataset is included in EDA.
...
def test_dev_instruments_schema_definition():
    ...
    try:
        ...
        dev_instruments_section = re.search(
            r'if table_name == "dev_instruments":(.*?)elif table_name ==',
            content,
            re.DOTALL
        )
...
def test_dev_instruments_row_count_realistic():
    ...
    try:
        ...
        if row_count_match:
            ...
            assert row_count < 100000, f"dev_instruments row count should be realistic, found {row_count}"
...
def run_dev_instruments_coverage_tests():
    ...
    tests = [
        ...
        ("dev_instruments Row Count Realistic", test_dev_instruments_row_count_realistic),
    ...
    if failed_tests:
        ...
        print(f"✅ dev_instruments is properly included in EDA")
...
if __name__ == "__main__":
    success = run_dev_instruments_coverage_tests()
