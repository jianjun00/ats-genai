        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                try:
                    ...
                    print(f"❌ loadAgentStatus test failed: {e}")
                ...
                try:
                    ...
                    print(f"❌ startAgent test failed: {e}")
                
                # Check network requests after function calls
                ...
                try:
                    ...
                    print(f"❌ JavaScript fetch test failed: {e}")
