...
class TestSecMasterDAO:
    ...
    async def test_get_spy_membership_events_success(self, dao):
        ...
        with patch('dao.secmaster_dao.asyncpg.create_pool', new_callable=AsyncMock, return_value=mock_pool):
    ...
    async def test_database_connection_error(self, dao):
        ...
        with patch('dao.secmaster_dao.asyncpg.create_pool', new_callable=AsyncMock, side_effect=connection_error):
