"""
Real objects integration tests for interfaces.rest_api.backanalytics_api.
...
class TestHealthEndpointRealObjects:
    """Real objects test suite for interfaces.rest_api.backanalytics_api."""
