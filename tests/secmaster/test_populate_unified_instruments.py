...
async def test_populate_unified_instruments_tickers_only(monkeypatch):
    ...
    with patch('src.secmaster.populate_unified_instruments.InstrumentPolygonDAO', return_value=mock_polygon), \
         patch('src.secmaster.populate_unified_instruments.InstrumentsDAO', return_value=mock_instruments), \
         patch('src.secmaster.populate_unified_instruments.UniverseMembershipDAO', return_value=mock_membership):
