"""
Real objects integration tests for training_data.structure_issues.
...
class TestTrainingDataStructureIssuesRealObjects:
    """Real objects test suite for training_data.structure_issues."""
