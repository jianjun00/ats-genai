"""
Real objects integration tests for training.multimodal_dataset_generator.
...
class TestMultiModalSampleRealObjects:
    """Real objects test suite for training.multimodal_dataset_generator."""
