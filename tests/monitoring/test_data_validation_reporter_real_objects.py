"""
Real objects integration tests for monitoring.data_validation_reporter.
...
class TestDataValidationReporterRealObjects:
    """Real objects test suite for monitoring.data_validation_reporter."""
