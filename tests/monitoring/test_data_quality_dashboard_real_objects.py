"""
Real objects integration tests for monitoring.data_quality_dashboard.
...
class TestDataQualityLevelRealObjects:
    """Real objects test suite for monitoring.data_quality_dashboard."""
