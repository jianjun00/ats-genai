"""
Real objects integration tests for performance.multimodal_performance.
...
class TestPerformanceBenchmarksRealObjects:
    """Real objects test suite for performance.multimodal_performance."""
