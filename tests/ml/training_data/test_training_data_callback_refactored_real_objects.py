"""
Real objects integration tests for ml.training_data.training_data_callback_refactored.
...
class TestTrainingDataCallbackRefactoredRealObjects:
    """Real objects test suite for ml.training_data.training_data_callback_refactored."""
