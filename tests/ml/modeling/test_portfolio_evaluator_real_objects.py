"""
Real objects integration tests for ml.modeling.portfolio_evaluator.
...
class TestPredictionRecordRealObjects:
    """Real objects test suite for ml.modeling.portfolio_evaluator."""
