"""
Real objects integration tests for ml.modeling.factor_models.
...
class TestMarketFactorCalculatorRealObjects:
    """Real objects test suite for ml.modeling.factor_models."""
