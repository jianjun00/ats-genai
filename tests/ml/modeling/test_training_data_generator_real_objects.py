"""
Real objects integration tests for ml.modeling.training_data_generator.
...
class TestTrainingConfigRealObjects:
    """Real objects test suite for ml.modeling.training_data_generator."""
