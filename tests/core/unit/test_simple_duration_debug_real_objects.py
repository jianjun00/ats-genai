"""
Real objects integration tests for unit.simple_duration_debug.
...
class TestSimpleDurationDebugRealObjects:
    """Real objects test suite for unit.simple_duration_debug."""
