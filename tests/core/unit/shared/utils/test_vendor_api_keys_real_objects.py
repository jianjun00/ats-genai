"""
Real objects integration tests for unit.shared.utils.vendor_api_keys.
...
class TestVendorAPIKeyMappingRealObjects:
    """Real objects test suite for unit.shared.utils.vendor_api_keys."""
