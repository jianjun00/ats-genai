"""
Real objects integration tests for unit.shared.utils.backfill_framework.
...
class TestBackfillStatsRealObjects:
    """Real objects test suite for unit.shared.utils.backfill_framework."""
