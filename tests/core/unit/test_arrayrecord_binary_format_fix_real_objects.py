"""
Real objects integration tests for unit.arrayrecord_binary_format_fix.
...
class TestArrayRecordBinaryFormatFixRealObjects:
    """Real objects test suite for unit.arrayrecord_binary_format_fix."""
