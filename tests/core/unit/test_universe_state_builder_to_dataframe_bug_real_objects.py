"""
Real objects integration tests for unit.universe_state_builder_to_dataframe_bug.
...
class TestUniverseStateBuilderToDataFrameBugRealObjects:
    """Real objects test suite for unit.universe_state_builder_to_dataframe_bug."""
