"""
Real objects integration tests for unit.training_schema_components.
...
class TestFeatureSchemaRealObjects:
    """Real objects test suite for unit.training_schema_components."""
