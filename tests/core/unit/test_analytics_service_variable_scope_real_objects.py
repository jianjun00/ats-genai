"""
Real objects integration tests for unit.analytics_service_variable_scope.
...
class TestAnalyticsServiceVariableScopeRealObjects:
    """Real objects test suite for unit.analytics_service_variable_scope."""
