"""
Real objects integration tests for unit.unified_market_cap_provider.
...
class TestUnifiedMarketCapProviderRealObjects:
    """Real objects test suite for unit.unified_market_cap_provider."""
