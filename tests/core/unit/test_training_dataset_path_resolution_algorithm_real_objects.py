"""
Real objects integration tests for unit.training_dataset_path_resolution_algorithm.
...
class TestTrainingDatasetPathResolutionAlgorithmRealObjects:
    """Real objects test suite for unit.training_dataset_path_resolution_algorithm."""
