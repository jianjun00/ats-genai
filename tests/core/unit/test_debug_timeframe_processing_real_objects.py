"""
Real objects integration tests for unit.debug_timeframe_processing.
...
class TestDebugTimeframeProcessingRealObjects:
    """Real objects test suite for unit.debug_timeframe_processing."""
