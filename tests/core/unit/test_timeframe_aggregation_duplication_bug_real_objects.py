"""
Real objects integration tests for unit.timeframe_aggregation_duplication_bug.
...
class TestTimeframeAggregationDuplicationBugRealObjects:
    """Real objects test suite for unit.timeframe_aggregation_duplication_bug."""
