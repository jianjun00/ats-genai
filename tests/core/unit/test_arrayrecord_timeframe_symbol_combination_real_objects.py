"""
Real objects integration tests for unit.arrayrecord_timeframe_symbol_combination.
...
class TestArrayRecordTimeframeSymbolCombinationRealObjects:
    """Real objects test suite for unit.arrayrecord_timeframe_symbol_combination."""
