"""
Real objects integration tests for unit.universe_cache_instrument_mismatch.
...
class TestUniverseCacheInstrumentMismatchRealObjects:
    """Real objects test suite for unit.universe_cache_instrument_mismatch."""
