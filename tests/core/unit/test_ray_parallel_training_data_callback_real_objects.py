"""
Real objects integration tests for unit.ray_parallel_training_data_callback.
...
class TestParallelSequenceGeneratorRealObjects:
    """Real objects test suite for unit.ray_parallel_training_data_callback."""
