"""
Real objects integration tests for core.business.calendars.exchange_calendar_enhanced.
...
class TestExchangeCalendarEnhancedRealObjects:
    """Real objects test suite for core.business.calendars.exchange_calendar_enhanced."""
