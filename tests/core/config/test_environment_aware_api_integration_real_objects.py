"""
Real objects integration tests for core.config.environment_aware_api_integration.
...
class TestEnvironmentAwareAPIsRealObjects:
    """Real objects test suite for core.config.environment_aware_api_integration."""
