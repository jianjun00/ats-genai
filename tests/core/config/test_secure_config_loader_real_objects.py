"""
Real objects integration tests for core.config.secure_config_loader.
...
class TestSecureConfigLoaderRealObjects:
    """Real objects test suite for core.config.secure_config_loader."""
