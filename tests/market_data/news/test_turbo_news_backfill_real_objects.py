"""
Real objects integration tests for market_data.news.turbo_news_backfill.
...
class TestTurboPolygonNewsFetcherRealObjects:
    """Real objects test suite for market_data.news.turbo_news_backfill."""
