"""
Real objects integration tests for market_data.realtime.aapl_tsla_collectors.
...
class TestAAPLTSLASyntheticCollectorRealObjects:
    """Real objects test suite for market_data.realtime.aapl_tsla_collectors."""
