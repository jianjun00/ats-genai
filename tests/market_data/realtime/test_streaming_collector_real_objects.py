"""
Real objects integration tests for market_data.realtime.streaming_collector.
...
class TestMinuteBarRealObjects:
    """Real objects test suite for market_data.realtime.streaming_collector."""
