"""
Real objects integration tests for market_data.realtime.metrics_exporter.
...
class TestMetricsCollectorRealObjects:
    """Real objects test suite for market_data.realtime.metrics_exporter."""
