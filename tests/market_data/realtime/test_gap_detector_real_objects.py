"""
Real objects integration tests for market_data.realtime.gap_detector.
...
class TestDataGapRealObjects:
    """Real objects test suite for market_data.realtime.gap_detector."""
