"""
Real objects integration tests for services.core.app.runner_interval_generation.
...
class TestRunnerIntervalGenerationRealObjects:
    """Real objects test suite for services.core.app.runner_interval_generation."""
