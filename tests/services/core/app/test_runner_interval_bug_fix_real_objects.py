"""
Real objects integration tests for services.core.app.runner_interval_bug_fix.
...
class TestRunnerIntervalBugFixRealObjects:
    """Real objects test suite for services.core.app.runner_interval_bug_fix."""
