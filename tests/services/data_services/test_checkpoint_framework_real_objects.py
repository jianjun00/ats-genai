"""
Real objects integration tests for services.data_services.checkpoint_framework.
...
class TestCheckpointManagerRealObjects:
    """Real objects test suite for services.data_services.checkpoint_framework."""
