"""
Real objects integration tests for services.news_processing_pipeline_e2e.
...
class TestNewsProcessingPipelineE2ERealObjects:
    """Real objects test suite for services.news_processing_pipeline_e2e."""
