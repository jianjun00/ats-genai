"""
Real objects integration tests for services.analytics_service_comprehensive.
...
class TestJobManagerRealObjects:
    """Real objects test suite for services.analytics_service_comprehensive."""
