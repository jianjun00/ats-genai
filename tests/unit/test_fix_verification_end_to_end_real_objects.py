"""
Real objects integration tests for unit.fix_verification_end_to_end.
...
class TestFixVerificationEndToEndRealObjects:
    """Real objects test suite for unit.fix_verification_end_to_end."""
