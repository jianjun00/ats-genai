"""
Real objects integration tests for unit.ohlcv_data_scoping_fix.
...
class TestOHLCVDataScopingFixRealObjects:
    """Real objects test suite for unit.ohlcv_data_scoping_fix."""
