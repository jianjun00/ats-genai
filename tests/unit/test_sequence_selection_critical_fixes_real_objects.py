"""
Real objects integration tests for unit.sequence_selection_critical_fixes.
...
class TestSequenceSelectionCriticalFixesRealObjects:
    """Real objects test suite for unit.sequence_selection_critical_fixes."""
