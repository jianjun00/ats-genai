"""
Real objects integration tests for unit.training_sequence_generation_comprehensive.
...
class TestTrainingSequenceGenerationComprehensiveRealObjects:
    """Real objects test suite for unit.training_sequence_generation_comprehensive."""
