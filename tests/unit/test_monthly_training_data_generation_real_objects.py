"""
Real objects integration tests for unit.monthly_training_data_generation.
...
class TestMonthlyTrainingDataDAORealObjects:
    """Real objects test suite for unit.monthly_training_data_generation."""
