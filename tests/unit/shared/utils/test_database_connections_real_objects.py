"""
Real objects integration tests for unit.shared.utils.database_connections.
...
class TestGetDatabasePoolRealObjects:
    """Real objects test suite for unit.shared.utils.database_connections."""
