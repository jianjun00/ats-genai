"""
Real objects integration tests for unit.universe_state_cache_population_issue.
...
class TestUniverseStateCachePopulationIssueRealObjects:
    """Real objects test suite for unit.universe_state_cache_population_issue."""
