"""
Real objects integration tests for events.earnings_pipeline_e2e.
...
class TestEarningsDataIngestionPipelineRealObjects:
    """Real objects test suite for events.earnings_pipeline_e2e."""
