"""
Real objects integration tests for events.event_system_integration.
...
class TestProtocolBufferEventsRealObjects:
    """Real objects test suite for events.event_system_integration."""
