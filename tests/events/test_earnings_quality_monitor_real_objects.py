"""
Real objects integration tests for events.earnings_quality_monitor.
...
class TestEarningsQualityMonitorRealObjects:
    """Real objects test suite for events.earnings_quality_monitor."""
