"""
Real objects integration tests for events.economic_events_classifier.
...
class TestEconomicEventsClassifierRealObjects:
    """Real objects test suite for events.economic_events_classifier."""
