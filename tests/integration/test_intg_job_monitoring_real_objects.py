"""
Real objects integration tests for integration.intg_job_monitoring.
...
class TestINTGJobMonitoringRealObjects:
    """Real objects test suite for integration.intg_job_monitoring."""
