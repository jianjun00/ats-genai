"""
Real objects integration tests for integration.performance_regression_endtoend.
...
class TestPerformanceRegressionRealObjects:
    """Real objects test suite for integration.performance_regression_endtoend."""
