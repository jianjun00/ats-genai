"""
Real objects integration tests for integration.configuration_enum_regression.
...
class TestEnumUsageRegressionRealObjects:
    """Real objects test suite for integration.configuration_enum_regression."""
