"""
Real objects integration tests for integration.database_constraints_regression.
...
class TestDatabaseConstraintsRegressionRealObjects:
    """Real objects test suite for integration.database_constraints_regression."""
