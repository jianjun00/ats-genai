"""
Real objects integration tests for integration.intg_startup_manager.
...
class TestStartupManagerDecisionTreeRealObjects:
    """Real objects test suite for integration.intg_startup_manager."""
