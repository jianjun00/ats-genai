"""
Real objects integration tests for integration.sequence_count_validation_pipeline.
...
class TestSequenceCountValidationPipelineRealObjects:
    """Real objects test suite for integration.sequence_count_validation_pipeline."""
