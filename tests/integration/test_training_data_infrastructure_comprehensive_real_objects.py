"""
Real objects integration tests for integration.training_data_infrastructure_comprehensive.
...
class TestFirstRateAdapterRealObjects:
    """Real objects test suite for integration.training_data_infrastructure_comprehensive."""
