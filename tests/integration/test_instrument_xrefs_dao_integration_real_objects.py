"""
Real objects integration tests for integration.instrument_xrefs_dao_integration.
...
class TestInstrumentXrefsDAOCoreRealObjects:
    """Real objects test suite for integration.instrument_xrefs_dao_integration."""
