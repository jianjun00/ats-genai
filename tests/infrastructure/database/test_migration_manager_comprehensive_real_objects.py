...
Generated from mock-based test: tests/infrastructure/database/test_migration_manager_comprehensive.py
...
class TestRealObjectsRealObjects:
    ...
    async def test_migration_with_environment_variables_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.migration_with_environment_variables(test_data)
    ...
    async def test_migration_idempotency_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.migration_idempotency(test_data)
