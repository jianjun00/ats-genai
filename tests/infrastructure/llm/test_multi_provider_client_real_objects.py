"""
Real objects integration tests for infrastructure.llm.multi_provider_client.
...
class TestLLMProviderBaseRealObjects:
    """Real objects test suite for infrastructure.llm.multi_provider_client."""
