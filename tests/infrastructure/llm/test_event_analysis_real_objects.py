"""
Real objects integration tests for infrastructure.llm.event_analysis.
...
class TestEventAnalysisRequestRealObjects:
    """Real objects test suite for infrastructure.llm.event_analysis."""
