"""
Real objects integration tests for market_data.realtime.performance_benchmarks.
...
class TestDataThroughputBenchmarksRealObjects:
    """Real objects test suite for market_data.realtime.performance_benchmarks."""
