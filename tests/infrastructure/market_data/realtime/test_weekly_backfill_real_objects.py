"""
Real objects integration tests for market_data.realtime.weekly_backfill.
...
class TestBackfillJobRealObjects:
    """Real objects test suite for market_data.realtime.weekly_backfill."""
