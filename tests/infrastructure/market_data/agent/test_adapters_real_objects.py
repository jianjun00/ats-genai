"""
Real objects integration tests for market_data.agent.adapters.
...
class TestPolygonAdapterRealObjects:
    """Real objects test suite for market_data.agent.adapters."""
