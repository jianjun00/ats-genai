"""
Real objects integration tests for infrastructure.redis_cache.
...
class TestCacheKeyBuilderRealObjects:
    """Real objects test suite for infrastructure.redis_cache."""
