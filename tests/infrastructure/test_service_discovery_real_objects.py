"""
Real objects integration tests for infrastructure.service_discovery.
...
class TestServiceRegistryRealObjects:
    """Real objects test suite for infrastructure.service_discovery."""
