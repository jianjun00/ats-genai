"""
Real objects integration tests for integration.arrayrecord_file_writing_debug.
...
class TestArrayRecordFileWritingDebugRealObjects:
    """Real objects test suite for integration.arrayrecord_file_writing_debug."""
