"""
Real objects integration tests for integration.arrayrecord_reading_compatibility.
...
class TestArrayRecordReadingCompatibilityRealObjects:
    """Real objects test suite for integration.arrayrecord_reading_compatibility."""
