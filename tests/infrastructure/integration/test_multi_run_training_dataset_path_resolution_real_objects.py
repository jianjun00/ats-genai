"""
Real objects integration tests for integration.multi_run_training_dataset_path_resolution.
...
class TestMultiRunTrainingDatasetPathResolutionRealObjects:
    """Real objects test suite for integration.multi_run_training_dataset_path_resolution."""
