"""
Real objects integration tests for integration.instrument_service_monitoring.
...
class TestInstrumentServiceMonitoringIntegrationRealObjects:
    """Real objects test suite for integration.instrument_service_monitoring."""
