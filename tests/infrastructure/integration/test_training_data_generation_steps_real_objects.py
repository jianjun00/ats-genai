"""
Real objects integration tests for integration.training_data_generation_steps.
...
class TestTrainingDataGenerationStepsRealObjects:
    """Real objects test suite for integration.training_data_generation_steps."""
