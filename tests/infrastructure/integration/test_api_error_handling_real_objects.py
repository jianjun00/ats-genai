"""
Real objects integration tests for integration.api_error_handling.
...
class TestAPIErrorHandlingRealObjects:
    """Real objects test suite for integration.api_error_handling."""
