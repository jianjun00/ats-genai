"""
Real objects integration tests for integration.schema_aware_training_generation.
...
class TestSchemaAwareTrainingGenerationRealObjects:
    """Real objects test suite for integration.schema_aware_training_generation."""
