"""
Real objects integration tests for integration.lead_vs_lag_price_validation.
...
class TestLeadVsLagPriceValidationRealObjects:
    """Real objects test suite for integration.lead_vs_lag_price_validation."""
