"""
Real objects integration tests for integration.service_architecture_validation.
...
class TestServiceArchitectureRealObjects:
    """Real objects test suite for integration.service_architecture_validation."""
