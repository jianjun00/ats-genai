"""
Real objects integration tests for integration.5m_interval_verification.
...
class Test5MinuteIntervalVerificationRealObjects:
    """Real objects test suite for integration.5m_interval_verification."""
