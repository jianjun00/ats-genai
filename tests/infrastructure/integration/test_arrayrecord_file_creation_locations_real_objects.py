"""
Real objects integration tests for integration.arrayrecord_file_creation_locations.
...
class TestArrayRecordFileCreationLocationsRealObjects:
    """Real objects test suite for integration.arrayrecord_file_creation_locations."""
