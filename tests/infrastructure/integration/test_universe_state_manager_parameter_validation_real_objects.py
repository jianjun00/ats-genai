"""
Real objects integration tests for integration.universe_state_manager_parameter_validation.
...
class TestUniverseStateManagerParameterValidationRealObjects:
    """Real objects test suite for integration.universe_state_manager_parameter_validation."""
