"""
Real objects integration tests for integration.actual_market_data_manager_lead_lag_integration.
...
class TestActualMarketDataManagerLeadLagIntegrationRealObjects:
    """Real objects test suite for integration.actual_market_data_manager_lead_lag_integration."""
