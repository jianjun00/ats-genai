"""
Real objects integration tests for integration.monthly_training_data_integration.
...
class TestMonthlyTrainingDataDatabaseIntegrationRealObjects:
    """Real objects test suite for integration.monthly_training_data_integration."""
