"""
Real objects integration tests for integration.instruments_api_integration.
...
class TestInstrumentsAPIIntegrationRealObjects:
    """Real objects test suite for integration.instruments_api_integration."""
