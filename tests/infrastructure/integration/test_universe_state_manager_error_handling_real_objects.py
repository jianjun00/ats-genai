"""
Real objects integration tests for integration.universe_state_manager_error_handling.
...
class TestUniverseStateManagerErrorHandlingRealObjects:
    """Real objects test suite for integration.universe_state_manager_error_handling."""
