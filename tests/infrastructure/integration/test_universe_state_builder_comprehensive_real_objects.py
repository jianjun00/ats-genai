"""
Real objects integration tests for integration.universe_state_builder_comprehensive.
...
class TestUniverseStateBuilderMultiTimeframeRealObjects:
    """Real objects test suite for integration.universe_state_builder_comprehensive."""
