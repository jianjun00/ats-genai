"""
Real objects integration tests for integration.arrayrecord_training_data_pipeline.
...
class TestArrayRecordTrainingDataPipelineRealObjects:
    """Real objects test suite for integration.arrayrecord_training_data_pipeline."""
