"""
Real objects integration tests for integration.sequence_selection_end_to_end.
...
class TestSequenceSelectionEndToEndRealObjects:
    """Real objects test suite for integration.sequence_selection_end_to_end."""
