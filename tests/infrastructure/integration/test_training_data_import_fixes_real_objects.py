"""
Real objects integration tests for integration.training_data_import_fixes.
...
class TestTrainingDataImportFixesRealObjects:
    """Real objects test suite for integration.training_data_import_fixes."""
