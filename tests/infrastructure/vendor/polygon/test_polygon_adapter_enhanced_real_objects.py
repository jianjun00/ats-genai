...
Generated from mock-based test: tests/infrastructure/vendor/polygon/test_polygon_adapter_enhanced.py
...
class TestRealObjectsPolygonAdapterEnhanced:
    ...
    async def test_fetch_instruments_success_real_objects(self, real_service, test_data):
        ...
        assert False, "Should have raised specific exception"
    async def test_fetch_instruments_fallback_instrument_id_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_instruments_fallback_instrument_id"""
        # Test with real database integration
        result = await real_service.fetch_instruments_fallback_instrument_id(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_instruments_fallback_instrument_id_with_invalid_data()
        assert False, "Should have raised specific exception"
    async def test_fetch_instruments_empty_results_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_instruments_empty_results"""
        # Test with real database integration
        result = await real_service.fetch_instruments_empty_results(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_instruments_empty_results_with_invalid_data()
        assert False, "Should have raised specific exception"
    async def test_fetch_instruments_missing_results_key_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_instruments_missing_results_key"""
        # Test with real database integration
        result = await real_service.fetch_instruments_missing_results_key(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_instruments_missing_results_key_with_invalid_data()
        assert False, "Should have raised specific exception"
    ...
    async def test_fetch_eod_http_error_real_objects(self, real_service, test_data):
        ...
        assert False, "Should have raised specific exception"
    async def test_fetch_eod_empty_results_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_eod_empty_results"""
        # Test with real database integration
        result = await real_service.fetch_eod_empty_results(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_eod_empty_results_with_invalid_data()
        assert False, "Should have raised specific exception"
    async def test_fetch_eod_missing_results_key_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_eod_missing_results_key"""
        # Test with real database integration
        result = await real_service.fetch_eod_missing_results_key(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_eod_missing_results_key_with_invalid_data()
        assert False, "Should have raised specific exception"
    async def test_fetch_eod_timezone_handling_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_eod_timezone_handling"""
        # Test with real database integration
        result = await real_service.fetch_eod_timezone_handling(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_eod_timezone_handling_with_invalid_data()
        assert False, "Should have raised specific exception"
    ...
    async def test_fetch_eod_missing_optional_fields_real_objects(self, real_service, test_data):
        ...
        assert False, "Should have raised specific exception"
    async def test_fetch_eod_json_serialization_error_handling_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_eod_json_serialization_error_handling"""
        # Test with real database integration
        result = await real_service.fetch_eod_json_serialization_error_handling(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_eod_json_serialization_error_handling_with_invalid_data()
        assert False, "Should have raised specific exception"
    ...
    async def test_vendor_name_real_objects(self, real_service, test_data):
        ...
        assert False, "Should have raised specific exception"
    async def test_fetch_instruments_partial_data_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_instruments_partial_data"""
        # Test with real database integration
        result = await real_service.fetch_instruments_partial_data(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_instruments_partial_data_with_invalid_data()
        assert False, "Should have raised specific exception"
    async def test_fetch_eod_url_format_validation_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_eod_url_format_validation"""
        # Test with real database integration
        result = await real_service.fetch_eod_url_format_validation(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_eod_url_format_validation_with_invalid_data()
        assert False, "Should have raised specific exception"
    async def test_fetch_eod_in_log_range_function_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_eod_in_log_range_function"""
        # Test with real database integration
        result = await real_service.fetch_eod_in_log_range_function(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_eod_in_log_range_function_with_invalid_data()
        assert False, "Should have raised specific exception"
    async def test_fetch_eod_handles_large_datasets_real_objects(self, real_service, test_data):
        """Real objects version of test_fetch_eod_handles_large_datasets"""
        # Test with real database integration
        result = await real_service.fetch_eod_handles_large_datasets(test_data)
        ...
        # Test fail-fast behavior
        await real_service.fetch_eod_handles_large_datasets_with_invalid_data()
        assert False, "Should have raised specific exception"
