"""
Real objects integration tests for infrastructure.vendor.polygon.polygon_adapter_enhanced.
...
class TestPolygonAdapterEnhancedRealObjects:
    """Real objects test suite for infrastructure.vendor.polygon.polygon_adapter_enhanced."""
