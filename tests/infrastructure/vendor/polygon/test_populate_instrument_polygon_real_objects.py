...
Generated from mock-based test: tests/infrastructure/vendor/polygon/test_populate_instrument_polygon.py
...
class TestRealObjectsPopulateInstrumentPolygon:
    ...
    async def test_parse_date_real_objects(self, real_service, test_data):
        ...
        result = await real_service.parse_date(test_data)
    ...
    async def test_fetch_single_ticker_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.fetch_single_ticker(test_data)
    ...
    async def test_command_line_environment_param_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.command_line_environment_param(test_data)
