...
Generated from mock-based test: tests/infrastructure/vendor/polygon/test_populate_instrument_polygon_ray.py
...
class DummyContext:
    ...
    async def test_parse_date_valid_real_objects(self, real_service, test_data):
        ...
        result = await real_service.parse_date_valid(test_data)
    ...
    async def test_ray_core_logic_dates_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.ray_core_logic_dates(test_data)
    ...
    async def test_ray_core_logic_none_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.ray_core_logic_none(test_data)
    ...
    async def test_ray_remote_db_args_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.ray_remote_db_args(test_data)
    ...
    async def test_ray_batched_upsert_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.ray_batched_upsert(test_data)
