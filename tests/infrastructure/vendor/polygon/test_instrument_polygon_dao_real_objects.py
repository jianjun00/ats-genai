"""
Real objects integration tests for infrastructure.vendor.polygon.instrument_polygon_dao.
...
class TestInstrumentPolygonDAORealObjects:
    """Real objects test suite for infrastructure.vendor.polygon.instrument_polygon_dao."""
