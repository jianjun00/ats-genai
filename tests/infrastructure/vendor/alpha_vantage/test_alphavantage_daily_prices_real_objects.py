"""
Real objects integration tests for infrastructure.vendor.alpha_vantage.alphavantage_daily_prices.
...
class TestAlphaVantageDailyPricesRealObjects:
    """Real objects test suite for infrastructure.vendor.alpha_vantage.alphavantage_daily_prices."""
