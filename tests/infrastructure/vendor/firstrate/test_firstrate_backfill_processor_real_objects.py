"""
Real objects integration tests for infrastructure.vendor.firstrate.firstrate_backfill_processor.
...
class TestFirstRateBackfillProcessorRealObjects:
    """Real objects test suite for infrastructure.vendor.firstrate.firstrate_backfill_processor."""
