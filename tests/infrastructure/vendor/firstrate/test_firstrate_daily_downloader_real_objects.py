"""
Real objects integration tests for infrastructure.vendor.firstrate.firstrate_daily_downloader.
...
class TestDownloadJobRealObjects:
    """Real objects test suite for infrastructure.vendor.firstrate.firstrate_daily_downloader."""
