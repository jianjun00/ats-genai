"""
Real objects integration tests for infrastructure.vendor.firstrate.firstrate_daily_download_script.
...
class TestFirstRateDownloadScriptRealObjects:
    """Real objects test suite for infrastructure.vendor.firstrate.firstrate_daily_download_script."""
