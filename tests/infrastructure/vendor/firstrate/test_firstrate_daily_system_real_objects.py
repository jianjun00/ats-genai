"""
Real objects integration tests for infrastructure.vendor.firstrate.firstrate_daily_system.
...
class TestFirstRateSystemIntegrationRealObjects:
    """Real objects test suite for infrastructure.vendor.firstrate.firstrate_daily_system."""
