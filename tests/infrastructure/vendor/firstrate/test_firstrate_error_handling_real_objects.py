"""
Real objects integration tests for infrastructure.vendor.firstrate.firstrate_error_handling.
...
class TestFirstRateErrorHandlingRealObjects:
    """Real objects test suite for infrastructure.vendor.firstrate.firstrate_error_handling."""
