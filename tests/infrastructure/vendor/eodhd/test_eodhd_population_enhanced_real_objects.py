"""
Real objects integration tests for infrastructure.vendor.eodhd.eodhd_population_enhanced.
...
class TestParseDateRealObjects:
    """Real objects test suite for infrastructure.vendor.eodhd.eodhd_population_enhanced."""
