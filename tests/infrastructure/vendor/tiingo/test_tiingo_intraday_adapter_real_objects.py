"""
Real objects integration tests for infrastructure.vendor.tiingo.tiingo_intraday_adapter.
...
class TestTiingoMinuteBarRealObjects:
    """Real objects test suite for infrastructure.vendor.tiingo.tiingo_intraday_adapter."""
