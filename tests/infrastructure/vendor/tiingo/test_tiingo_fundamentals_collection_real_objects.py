"""
Real objects integration tests for infrastructure.vendor.tiingo.tiingo_fundamentals_collection.
...
class TestTiingoFundamentalsCollectionRealObjects:
    """Real objects test suite for infrastructure.vendor.tiingo.tiingo_fundamentals_collection."""
