"""
Real objects integration tests for infrastructure.vendor.tiingo.tiingo_news_collection.
...
class TestTiingoNewsCollectionRealObjects:
    """Real objects test suite for infrastructure.vendor.tiingo.tiingo_news_collection."""
