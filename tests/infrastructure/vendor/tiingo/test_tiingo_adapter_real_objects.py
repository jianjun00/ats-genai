"""
Real objects integration tests for infrastructure.vendor.tiingo.tiingo_adapter.
...
class TestTiingoAdapterRealObjects:
    """Real objects test suite for infrastructure.vendor.tiingo.tiingo_adapter."""
