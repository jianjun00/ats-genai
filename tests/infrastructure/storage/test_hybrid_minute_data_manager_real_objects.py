"""
Real objects integration tests for infrastructure.storage.hybrid_minute_data_manager.
...
class TestStorageConfigRealObjects:
    """Real objects test suite for infrastructure.storage.hybrid_minute_data_manager."""
