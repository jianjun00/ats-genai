"""
Real objects integration tests for monitoring.data_quality_validator.
...
class TestDataQualityValidatorRealObjects:
    """Real objects test suite for monitoring.data_quality_validator."""
