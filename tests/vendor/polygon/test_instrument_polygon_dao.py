...
class TestInstrumentPolygonDAO:
    ...
    async def test_count_instruments_success(self, dao):
        ...
        with patch(\'domains.market_data.repositories.instrument_polygon_dao.asyncpg.create_pool\', new_callable=AsyncMock, return_value=mock_pool):
    ...
    async def test_database_connection_error(self, dao):
        ...
        with patch(\'domains.market_data.repositories.instrument_polygon_dao.asyncpg.create_pool\', new_callable=AsyncMock, side_effect=connection_error):
