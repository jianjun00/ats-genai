"""
Real objects integration tests for agents.system_monitor_fail_fast.
...
class TestSystemMonitorFailFastRealObjects:
    """Real objects test suite for agents.system_monitor_fail_fast."""
