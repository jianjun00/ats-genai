"""
Real objects integration tests for domains.analytics.analytics_events_service_migration.
...
class TestAnalyticsEventsServiceMigrationRealObjects:
    """Real objects test suite for domains.analytics.analytics_events_service_migration."""
