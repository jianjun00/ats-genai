"""
Real objects integration tests for events.support_resistance_processor.
...
class TestSupportResistanceProcessorRealObjects:
    """Real objects test suite for events.support_resistance_processor."""
