"""
Real objects integration tests for domains.analytics.services.schema_eda_integration.
...
class TestSchemaEDAIntegrationRealObjects:
    """Real objects test suite for domains.analytics.services.schema_eda_integration."""
