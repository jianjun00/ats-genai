"""
Real objects integration tests for domains.analytics.services.sentiment.news_sentiment_analyzer.
...
class TestSentimentScoreRealObjects:
    """Real objects test suite for domains.analytics.services.sentiment.news_sentiment_analyzer."""
