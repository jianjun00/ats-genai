"""
Real objects integration tests for domains.analytics.services.sentiment.social_media_analyzer.
...
class TestSocialMediaPostRealObjects:
    """Real objects test suite for domains.analytics.services.sentiment.social_media_analyzer."""
