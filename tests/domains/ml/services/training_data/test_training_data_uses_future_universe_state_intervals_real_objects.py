...
Generated from mock-based test: tests/domains/ml/services/training_data/test_training_data_uses_future_universe_state_intervals.py
...
class MockUniverseStateManagerWithFutureIntervals:
    ...
    async def test_get_timeframe_data_uses_future_universe_state_interval_real_objects(self, real_service, test_data):
        ...
        result = await real_service.get_timeframe_data_uses_future_universe_state_interval(test_data)
    ...
    async def test_future_vs_current_data_consistency_real_objects(self, real_service, test_data):
        ...
        # Test with real database integration
        result = await real_service.future_vs_current_data_consistency(test_data)
