"""
Real objects integration tests for training_data.single_file_multi_day_arrayrecord.
...
class TestSingleFileMultiDayArrayRecordRealObjects:
    """Real objects test suite for training_data.single_file_multi_day_arrayrecord."""
