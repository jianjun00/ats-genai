"""
Real objects integration tests for domains.ml.services.training_data.news_event_integration.
...
class TestNewsEventIntegrationRealObjects:
    """Real objects test suite for domains.ml.services.training_data.news_event_integration."""
