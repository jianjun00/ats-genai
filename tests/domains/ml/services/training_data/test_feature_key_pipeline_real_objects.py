"""
Real objects integration tests for domains.ml.services.training_data.feature_key_pipeline.
...
class TestFeatureExtractionKeysRealObjects:
    """Real objects test suite for domains.ml.services.training_data.feature_key_pipeline."""
