"""
Real objects integration tests for domains.ml.services.sr_backtester.
...
class TestPredictionResultRealObjects:
    """Real objects test suite for domains.ml.services.sr_backtester."""
