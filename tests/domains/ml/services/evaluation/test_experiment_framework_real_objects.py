"""
Real objects integration tests for domains.ml.services.evaluation.experiment_framework.
...
class TestExperimentConfigRealObjects:
    """Real objects test suite for domains.ml.services.evaluation.experiment_framework."""
