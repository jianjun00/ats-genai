"""
Real objects integration tests for domains.ml.services.feature_metadata_performance.
...
class TestFeatureMetadataPerformanceRealObjects:
    """Real objects test suite for domains.ml.services.feature_metadata_performance."""
