"""
Real objects integration tests for domains.ml.services.support_resistance_generator.
...
class TestSupportResistanceTrainingGeneratorRealObjects:
    """Real objects test suite for domains.ml.services.support_resistance_generator."""
