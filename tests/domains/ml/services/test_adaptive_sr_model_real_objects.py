"""
Real objects integration tests for domains.ml.services.adaptive_sr_model.
...
class TestAdaptiveModelConfigRealObjects:
    """Real objects test suite for domains.ml.services.adaptive_sr_model."""
