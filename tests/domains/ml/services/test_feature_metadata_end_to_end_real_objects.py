"""
Real objects integration tests for domains.ml.services.feature_metadata_end_to_end.
...
class TestFeatureMetadataEndToEndRealObjects:
    """Real objects test suite for domains.ml.services.feature_metadata_end_to_end."""
