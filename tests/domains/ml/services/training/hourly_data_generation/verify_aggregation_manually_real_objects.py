...
Generated from mock-based test: tests/domains/ml/services/training/hourly_data_generation/verify_aggregation_manually.py
...
class SimpleConfig:
    ...
    async def test_aggregation_real_objects(self, real_service, test_data):
        """Real objects version of test_aggregation"""
        # Test with real database integration
        result = await real_service.aggregation(test_data)
        ...
        await real_service.aggregation_with_invalid_data()
