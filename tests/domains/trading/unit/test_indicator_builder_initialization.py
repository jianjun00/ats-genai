...
class TestIndicatorBuilderInitialization:
    ...
    def test_indicator_builder_import_success(self):
        ...
        from domains.trading.services.indicatorss.indicator_builder import IndicatorBuilder
        from domains.trading.services.indicatorss.indicator_config import IndicatorConfig
