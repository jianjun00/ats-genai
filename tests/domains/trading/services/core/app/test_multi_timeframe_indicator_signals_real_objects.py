"""
Real objects integration tests for app.multi_timeframe_indicator_signals.
...
class TestMultiTimeframeIndicatorSignalsRealObjects:
    """Real objects test suite for app.multi_timeframe_indicator_signals."""
