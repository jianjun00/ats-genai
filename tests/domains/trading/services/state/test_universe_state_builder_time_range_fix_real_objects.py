"""
Real objects integration tests for domains.trading.services.state.universe_state_builder_time_range_fix.
...
class TestUniverseStateBuilderTimeRangeFixRealObjects:
    """Real objects test suite for domains.trading.services.state.universe_state_builder_time_range_fix."""
