"""
Real objects integration tests for domains.trading.services.universe.historical_universe_creator.
...
class TestHistoricalStockRealObjects:
    """Real objects test suite for domains.trading.services.universe.historical_universe_creator."""
