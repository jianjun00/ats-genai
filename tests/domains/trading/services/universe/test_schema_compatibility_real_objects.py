"""
Real objects integration tests for domains.trading.services.universe.schema_compatibility.
...
class TestSchemaCompatibilityRealObjects:
    """Real objects test suite for domains.trading.services.universe.schema_compatibility."""
