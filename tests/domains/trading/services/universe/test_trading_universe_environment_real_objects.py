"""
Real objects integration tests for domains.trading.services.universe.trading_universe_environment.
...
class TestSecurityMasterEnvironmentRealObjects:
    """Real objects test suite for domains.trading.services.universe.trading_universe_environment."""
