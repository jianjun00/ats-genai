"""
Real objects integration tests for domains.trading.services.universe.start_at_date_bug_fix.
...
class TestStartAtDateBugFixRealObjects:
    """Real objects test suite for domains.trading.services.universe.start_at_date_bug_fix."""
