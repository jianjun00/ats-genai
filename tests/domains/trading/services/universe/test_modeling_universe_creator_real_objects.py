"""
Real objects integration tests for domains.trading.services.universe.modeling_universe_creator.
...
class TestModelingUniverseCreatorCoreRealObjects:
    """Real objects test suite for domains.trading.services.universe.modeling_universe_creator."""
