"""
Real objects integration tests for domains.instruments.services.data_population_issues.
...
class TestDataPopulationIssuesRealObjects:
    """Real objects test suite for domains.instruments.services.data_population_issues."""
