"""
Real objects integration tests for domains.instruments.services.bulk_instrument_population.
...
class TestBulkInstrumentPopulationRealObjects:
    """Real objects test suite for domains.instruments.services.bulk_instrument_population."""
