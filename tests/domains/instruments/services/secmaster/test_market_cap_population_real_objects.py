"""
Real objects integration tests for domains.instruments.services.secmaster.market_cap_population.
...
class TestMarketCapPopulationRealObjects:
    """Real objects test suite for domains.instruments.services.secmaster.market_cap_population."""
