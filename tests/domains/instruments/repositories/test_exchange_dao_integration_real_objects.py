"""
Real objects integration tests for domains.instruments.repositories.exchange_dao_integration.
...
class TestExchangeDAOIntegrationRealObjects:
    """Real objects test suite for domains.instruments.repositories.exchange_dao_integration."""
