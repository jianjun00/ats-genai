"""
Real objects integration tests for domains.instruments.repositories.secmaster_dao.
...
class TestSecMasterDAORealObjects:
    """Real objects test suite for domains.instruments.repositories.secmaster_dao."""
