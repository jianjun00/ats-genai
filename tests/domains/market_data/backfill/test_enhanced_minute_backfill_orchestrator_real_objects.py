"""
Real objects integration tests for market_data.backfill.enhanced_minute_backfill_orchestrator.
...
class TestJobSegmentRealObjects:
    """Real objects test suite for market_data.backfill.enhanced_minute_backfill_orchestrator."""
