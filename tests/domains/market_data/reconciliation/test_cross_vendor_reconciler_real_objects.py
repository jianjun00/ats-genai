"""
Real objects integration tests for market_data.reconciliation.cross_vendor_reconciler.
...
class TestVendorBarRealObjects:
    """Real objects test suite for market_data.reconciliation.cross_vendor_reconciler."""
