"""
Real objects integration tests for market_data.reconciliation.majority_voting_reconciler.
...
class TestVendorPriceRealObjects:
    """Real objects test suite for market_data.reconciliation.majority_voting_reconciler."""
