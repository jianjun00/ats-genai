"""
Real objects integration tests for market_data.eod.db_daily_price_market_data_manager_dao.
...
class TestDBDailyPriceMarketDataManagerDAORealObjects:
    """Real objects test suite for market_data.eod.db_daily_price_market_data_manager_dao."""
