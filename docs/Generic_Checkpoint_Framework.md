# Generic Checkpoint Framework for Long-Running Jobs
...
**Implementation Status**: Database schema design completed, core framework implementation in progress.
...
## Technical Architecture (From DRD)
...
class CheckpointableJob:
    """Abstract interface for resumable jobs."""
...
CREATE TABLE dev_job_progress (
    job_run_id INTEGER REFERENCES dev_job_runs(id),
