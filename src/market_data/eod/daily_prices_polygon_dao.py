...
class DailyPricesPolygonDAO:
    ...
    async def insert_price(self, date, symbol=None, instrument_id=None, open_=None, high=None, low=None, close=None, volume=None, market_cap=None, vendor_id=None, at_date=None):
        """
        ...
        try:
            async with pool.acquire() as conn:
                await conn.execute(f"""
                    INSERT INTO {self.table_name} (date, symbol, instrument_id, open, high, low, close, volume, market_cap)
                    VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
                """, date, symbol, instrument_id, open_, high, low, close, volume, market_cap)
        finally:
            await pool.close()
