"""
FMP (Financial Modeling Prep) Fundamentals DAO

Handles fundamental data operations for FMP vendor data in the comprehensive
...
@dataclass
class FMPFundamental:
    """FMP fundamental data container"""
    symbol: str
    date: date
    vendor: str = 'fmp'
