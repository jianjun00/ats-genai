...
Usage:
    PYTHONPATH=src python -m domains.workflow.tiingo.backfill.data_collector [--days DAYS] [--symbols SYMBOLS] [--debug]

Examples:
    PYTHONPATH=src python -m domains.workflow.tiingo.backfill.data_collector --days 7 --symbols 50
    PYTHONPATH=src python -m domains.workflow.tiingo.backfill.data_collector --debug
"""
import asyncio
import asyncpg
import requests
