...
def execute_query(query: str, params: Optional[tuple] = None) -> List[Dict[str, Any]]:
    ...
    Usage:
        from shared.utils.db_utils import execute_query
...
def execute_update(query: str, params: Optional[tuple] = None) -> int:
    ...
    Usage:
        from shared.utils.db_utils import execute_update
...
def get_table_name(base_name: str) -> str:
    ...
    Usage:
        from shared.utils.db_utils import get_table_name
...
def check_connection() -> bool:
    ...
    Usage:
        from shared.utils.db_utils import check_connection
...
def get_connection_config() -> Dict[str, Any]:
    ...
    Usage:
        from shared.utils.db_utils import get_connection_config
...
def get_api_key(vendor: str) -> Optional[str]:
    ...
    Usage:
        from shared.utils.db_utils import get_api_key
