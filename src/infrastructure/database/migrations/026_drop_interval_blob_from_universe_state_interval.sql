-- Migration 026: Remove legacy interval_blob column from universe_state_interval
-- Context: Older schemas stored a serialized protobuf in interval_blob BYTEA NOT NULL.
-- The project has migrated to a normalized schema, so this column is obsolete
