...
('dev_daily_prices_tiingo', 'symbol', 'identifier', NULL, 'Stock ticker symbol'),
('dev_daily_prices_tiingo', 'date', 'date', NULL, 'Trading date'),
('dev_daily_prices_tiingo', 'open', 'numeric', NULL, 'Opening price'),
('dev_daily_prices_tiingo', 'high', 'numeric', NULL, 'Highest price during trading day'),
('dev_daily_prices_tiingo', 'low', 'numeric', NULL, 'Lowest price during trading day'),
('dev_daily_prices_tiingo', 'close', 'numeric', NULL, 'Closing price'),
('dev_daily_prices_tiingo', 'volume', 'numeric', NULL, 'Number of shares traded'),
