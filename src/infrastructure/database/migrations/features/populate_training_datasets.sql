...
(
    ...
    'training_dataset',
    '/data/training_data/ml_features_v1.parquet',
    125000,
    47,
    'parquet',
    FALSE,
...
(
    ...
    'training_dataset',
    '/data/training_data/backtest_2024.csv',
    52000,
    23,
    'csv',
    FALSE,
...
(
    ...
    'training_dataset',
    '/data/training_data/portfolio_features.json',
    89000,
    35,
    'json',
    FALSE,
...
(
    ...
    'training_dataset',
    '/data/training_data/sentiment_data.parquet',
    340000,
    12,
    'parquet',
    FALSE,
