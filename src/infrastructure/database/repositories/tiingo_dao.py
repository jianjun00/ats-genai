...
previously scattered across multiple files like daily_prices_tiingo_dao.py,
...
from infrastructure.database.repositories.base.vendor_dao import MarketDataVendorDAO, VendorType
from domains.market_data.repositories.market_data.daily_prices_dao import DailyPricesDAO
