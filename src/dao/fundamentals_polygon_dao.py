"""
Polygon Fundamentals DAO

Handles fundamental data operations for Polygon vendor data in the comprehensive
...
@dataclass
class PolygonFundamental:
    """Polygon fundamental data container"""
    symbol: str
    date: date
    vendor: str = 'polygon'
