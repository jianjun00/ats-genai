...
from shared.utils.config_utils import DatabaseConfig, load_database_config
from shared.utils.validation_utils import ValidationResult, validate_data_completeness
...
class QueryBuilder:
    ...
    def _get_table_name(self) -> str:
        ...
        from shared.utils.config_utils import get_table_name
