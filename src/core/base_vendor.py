...
from core.shared.utils_core.http_response_handlers import handle_vendor_response, ResponseStats
from core.shared.utils_core.validation_utils import validate_stock_symbol, validate_date_range
from core.shared.data_transformers import transform_vendor_dividend, transform_vendor_instrument
from core.shared.utils_core.math_utils import safe_divide, calculate_statistics
...
def create_vendor_from_env(vendor_name: str) -> Optional[BaseVendor]:
    ...
    from core.shared.utils_core.config_utils import load_vendor_config
