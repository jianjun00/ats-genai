...
def fetch_tiingo_dividends(symbol, api_key):
    url = f"https://api.tiingo.com/tiingo/daily/{symbol}/dividends?token={api_key}"
...
async def main():
    ...
    for symbol in symbols:
        tiingo_divs = fetch_tiingo_dividends(symbol, api_key)
